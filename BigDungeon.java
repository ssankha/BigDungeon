...
public class BigDungeon extends Canvas implements Runnable
{
    ...
    public State state = State.Level1;
    ...
    public BigDungeon()
    {
        new Display( 1200, 1000, "Big Dungeon", this );
        start();
    ...
    public void render()
    {
        ...
        if ( state == State.Level1 )
        {
            g.drawImage( floor, 0, 0, 1200, 1000, this );
        ...
        {
            g.drawImage( menuScreen, 0, 0, 1200, 1000, this );
            g.drawImage( menuTitle, 200, 20, 800, 200, this );

            g.drawImage( playButton, 450, 300, 300, 100, this );
            g.drawImage( helpButton, 450, 500, 300, 100, this );
            g.drawImage( quitButton, 450, 700, 300, 100, this );
        ...
        {
            g.drawImage( helpScreen, 0, 0, 1200, 1000, this );
            g.drawImage( menuButton, 850, 800, 300, 100, this );
        ...
        {
            g.drawImage( gameOver, 0, 0, 1200, 1000, this );
        ...
        {
            g.drawImage( levelScreen, 0, 0, 1200, 1000, this );
            g.drawImage( level1Button, 75, 400, 300, 100, this );
            g.drawImage( level2Button, 450, 400, 300, 100, this );
            g.drawImage( level3Button, 825, 400, 300, 100, this );
        ...
        {
            g.drawImage( winScreen, 0, 0, 1200, 1000, this );
            g.drawImage( menuButton, 50, 800, 300, 100, this );
            g.drawImage( nextLevelButton, 850, 800, 300, 100, this );
